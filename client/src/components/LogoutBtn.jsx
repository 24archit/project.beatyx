      ...
      >
        ...
        <DialogContent>
          <StyledDialogContentText id="alert-dialog-description">
            ...
            <br />
            <br />
            Note: To abort the permissions given during authorization, visit{" "}
            <a
              href="https://www.spotify.com/in-en/account/apps/"
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: "#e4a81db4", textDecoration: "underline" }}
            >
              Spotify Account
            </a>
