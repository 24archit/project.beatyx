...
export default function Side({ isAuth, isSpotifyConnected }) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      to: "/playlists",
      authRequired: true,
      alertMsg: "Please sign up or login to access your Playlists!",
    },
    {
      label: "Albums",
      icon: (
      ...
      to: "/albums",
      authRequired: true,
      alertMsg: "Please sign up or login to access your Saved Albums!",
    },
    {
      label: "Settings",
      icon: (
      ...
      to: "/settings",
      authRequired: true,
      alertMsg: "Please sign up or login to access your Settings!",
    },
  ];
