    ...
    <div className="track-line-card">
      ...
      <div className="Track-name">
        <Link to={`/track/${cardId}`} style={{ textDecoration: "none", color: "inherit" }}>
          <p
            style={isCurrentTrack ? { color: "#1db954", fontWeight: "bold" } : {}}
            title={trackName}
          >
            {trackName}
          </p>
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", padding: "0.4rem" }}>
      <Skeleton
        ...
        width={30}
        height={30}
        sx={{ bgcolor: "rgba(71, 164, 211, 0.261)", borderRadius: "0.3rem", marginRight: "2rem" }}
      />
      <div className="Track-name">
        <p>
          <Skeleton
            ...
            width={950}
            height={30}
            sx={{ bgcolor: "rgba(71, 164, 211, 0.261)", borderRadius: "0.3rem" }}
          />
        </p>
      </div>
    </div>
