...
export function TrackMainInfo({ trackName, artists, albumName, releaseDate, img }) {
  ...
  return (
    <div className="mainInfo-1">
      ...
      <div className="name-stat-1">
        ...
        <p id="playlist-name" style={{ fontSize: "3rem" }}>
          {trackName}
        </p>
        <p id="playlist-description">
          {artistNames} • {albumName} • {year}
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="mainInfo-1">
      ...
      <div className="name-stat-1" style={{ width: "100%", gap: "1rem" }}>
        ...
        <Skeleton
          sx={{ bgcolor: "rgba(71, 164, 211, 0.261)", fontSize: "4rem", width: "60%", height: 80 }}
        />
