...
import { getCategoryPlaylists } from "@/services/contentService";
                ...
                cardStat={
                  <span
                    ...
                    dangerouslySetInnerHTML={{
                      __html: item.description || `By ${item.owner?.display_name || "Spotify"}`,
                    }}
                    style={{
                      display: "-webkit-box",
                      WebkitLineClamp: 2,
          ...
          {isEmpty && (
            ...
            >
              <i
                ...
                style={{ fontSize: "2rem", marginBottom: "1rem", color: "#2979ff" }}
              ></i>
